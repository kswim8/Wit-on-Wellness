...
Thanks to my mentor Alex Xie, who suggested this to me, and provided me a Simplex Algorithm Video to learn the algorithm in under 10 minutes, I was able to create optimized solutions for linear systems, otherwise known as linear programming.
...
The main API that this app pulls data from is the FoodData Central API.

The API endpoint I called was the POST request for /foods/search to returns a list of foods that matched search (query) keywords.
